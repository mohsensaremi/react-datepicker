  ...
  describe("date_utils", function () {
    ...
    describe("isEqual", function () {
      ...
      it("should return false for non-equal date and date with time", function () {
        expect(isEqual(newDate("2016-02-10"), newDate("2016-02-11 13:13"))).to
          .be.false;
      });
    ...
    describe("isSameQuarter", function () {
      ...
      it("should return false for non-equal quarters ", function () {
        expect(isSameQuarter(newDate("2016-02-10"), newDate("2016-04-10"))).to
          .be.false;
      });

      it("should return true for equal quarters", function () {
        expect(isSameQuarter(newDate("2016-02-10"), newDate("2016-03-29"))).to
          .be.true;
      });
    });
    ...
    describe("isValid", () => {
      it("should return true if date is valid and equal or after minDate", () => {
        expect(isValid(newDate("2021-11-15"), newDate("2021-11-15"))).to.be
          .true;
        expect(isValid(newDate("2021-11-30"), newDate("2021-11-15"))).to.be
          .true;
      });

      it("should return false if date is valid and before minDate", () => {
        expect(isValid(newDate("2021-11-01"), newDate("2021-11-15"))).to.be
          .false;
      });
    });
